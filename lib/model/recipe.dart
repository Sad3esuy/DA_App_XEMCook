...
class Recipe {
  ...
  Recipe copyWith({
    ...
    int? totalRatingImages,
    List<Map<String, dynamic>>? ratingImagesPreview,
  }) {
    return Recipe(
      id: id ?? this.id,
      ...
      totalRatingImages: totalRatingImages ?? this.totalRatingImages,
      ratingImagesPreview: ratingImagesPreview ?? this.ratingImagesPreview,
    );
  }
}
